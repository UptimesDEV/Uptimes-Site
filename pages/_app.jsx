...
export default function AwardApp({ Component, pageProps }) {
  ...
  const NavItems = [
    ...
    },
    {
      ...
      href: "https://discord.gg/xPVjRkaAef",
    },
    {
      link: true,
      name: "Botu Ekle",
      ...
      href: "https://discord.com/oauth2/authorize?client_id=848465931978145802&scope=bot",
    },
       {
      link: true,
      name: "Oy Ver",
      ...
      href: "https://top.gg/bot/848465931978145802/vote",
    },
    {
      link: true,
      name: "Partnerler",
